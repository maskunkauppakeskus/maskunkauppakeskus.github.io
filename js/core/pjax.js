...
// --- Karuselli-delegaatti (Core) --------------------------------------------
// Core ei enää sisällä karusellilogikkaa eikä arvaa tiedostonimiä.
// Ulkoinen banner-carousel.js asettaa oikean toteutuksen.
if (!window.initBannerCarousel) {
  window.initBannerCarousel = async function initBannerCarousel() { /* no-op */ };
}
